...
yy: {},
symbols_: {"error":2,"html":3,"ficha":4,"DOT":5,"EOF":6,"title":7,"info":8,"sinop":9,"link":10,"TITULO":11,"LITERALTEXT":12,"DOTCOMMA":13,"op":14,"INFORMACION":15,"SINOPSIS":16,"ENLACE":17,"ENTRANCE":18,"DOUBLEDOT":19,"$accept":0,"$end":1},
terminals_: {2:"error",5:"DOT",6:"EOF",11:"TITULO",12:"LITERALTEXT",13:"DOTCOMMA",15:"INFORMACION",16:"SINOPSIS",17:"ENLACE",18:"ENTRANCE",19:"DOUBLEDOT"},
productions_: [0,[3,3],[4,0],[4,2],[4,2],[4,2],[4,2],[7,4],[8,3],[9,3],[10,3],[14,0],[14,6],[14,4]],
...
rules: [/^(?:\s+|#.*)/,/^(?:TITULO\b)/,/^(?:INFORMACION\b)/,/^(?:SINOPSIS\b)/,/^(?:ENLACE\b)/,/^(?:\[\])/,/^(?:[*])/,/^(?:[;])/,/^(?:[:])/,/^(?:[.])/,/^(?:$)/,/^(?:([A-Za-z_,.\|áéíóúäëïöüñ\/-|d+("."\d*)?]\w*\s*)+\??)/,/^(?:.)/],
